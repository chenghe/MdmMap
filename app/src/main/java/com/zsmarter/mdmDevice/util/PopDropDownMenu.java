...
public class PopDropDownMenu extends LinearLayout {
    ...
    public static final int LEFT_ONLY = 4;
    ...
    private List<OrganListResponseBody.Context.Page.RowItem> leftList1 = new ArrayList<>();//左侧左List
    private List<OrganListResponseBody.Context.Page.RowItem> leftList2 = new ArrayList<>();//左侧右List
    private List<OrganListResponseBody.Context.Page.RowItem> midList = new ArrayList<>();//中间list
    private List<OrganListResponseBody.Context.Page.RowItem> rightList = new ArrayList<>();//右侧list
    ...
    private void init() {
        ...
        mLeftPopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                ...
                left.setBackgroundColor(getResources().getColor(R.color.colorWhite));
        ...
        mRightPopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            @Override
            public void onDismiss() {
                right.setBackgroundColor(getResources().getColor(R.color.colorWhite));
        ...
        mMidPopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            @Override
            public void onDismiss() {
                mid.setBackgroundColor(getResources().getColor(R.color.colorWhite));
...
//        mMenuLeftList1.setSelector(R.drawable.selector_dropdownmenu_left);
        ...
        mMenuLeftList2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                tvLeft.setText(leftList2.get(position).getOrgName());
...
//				rightAdapter.setShowCheck(RIGHTCLICK);
                tvRigh.setText(rightList.get(position).getOrgName());
        ...
        mMenuMidList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                tvMid.setText(midList.get(position).getOrgName());
...
//                    rightAdapter.setShowCheck(RIGHTCLICK);
    ...
    public void setmMenuLeftList1(List<OrganListResponseBody.Context.Page.RowItem> list) {
        leftList1.clear();
        leftList1.addAll(list);
        leftAdapter1.notifyData(leftList1);
    }

    public void setmMenuLeftList2(List<OrganListResponseBody.Context.Page.RowItem> list) {
        leftList2.clear();
        leftList2.addAll(list);
        leftAdapter2.notifyData(leftList2);
    }

    public void setmMenuMidList(List<OrganListResponseBody.Context.Page.RowItem> list) {
        midList = list;
        midAdapter.notifyData(midList);
    }

    public void setmMenuRightList(List<OrganListResponseBody.Context.Page.RowItem> list) {
        rightList = list;
